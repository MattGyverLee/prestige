...
const mapStateToProps = (state : actions.StateProps): StateProps => ({url: state.player.url, loaded: state.tree.loaded, userName: state.system.userName});
...
export default withSplashScreen(withSnackbar(connect(mapStateToProps, mapDispatchToProps)(App)));
